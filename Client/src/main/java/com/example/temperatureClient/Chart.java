package com.example.temperatureClient;

import com.example.temperatureClient.DTO.MeasureRespons;
import com.example.temperatureClient.DTO.MeasurementDTO;
...
public class Chart {
    ...
    private static List<Double> getTemperaturesFromServer() {
        ...
        MeasureRespons jsonResponse = restTemplate.getForObject(url, MeasureRespons.class);
